import {ActionIcon, Anchor, Avatar, Badge, Button, Group, SegmentedControl, Select, Text} from '@mantine/core'
                                        ...
                                        <div>
                                            <Text size='lg' fw='bold'>
                                                ...
                                                {item.role == 'SUPERADMIN' && (
                                                    <Badge ml='md' color='grape' h='1.5rem'>
                                                        QTV cao cấp
                                                    </Badge>
                                                )}
                                                {item.role == 'ADMIN' && (
                                                    <Badge ml='md' color='teal' h='1.5rem'>
                                                        Quản trị viên
                                                    </Badge>
                                                )}
                                                {item.role == 'CONTRIBUTOR' && (
                                                    <Badge ml='md' color='orange' h='1.5rem'>
                                                        Cộng tác viên
                                                    </Badge>
                                                )}
                                            </Text>
