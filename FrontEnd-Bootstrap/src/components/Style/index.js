...
export function Style() {
    ...
    return (
        <style type='text/css'>
            {`
:root {
    --primary-color-0: #fff1e2;
    --primary-color-1: #f3d7bd;
    --primary-color-2: #ECC8AA;
    --primary-color-3: #dda16e;
    --primary-color-4: #d48746;
    --primary-color-5: #bb6d2d;
    --primary-color-6: #915422;
    --primary-color-7: #683c17;
    --primary-color-8: #40240b;
    --primary-color-9: #1a0a00;
}

body {
     font-family: ${settings[1].fontFamily};
